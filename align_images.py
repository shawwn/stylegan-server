        ...
        try:
            ...
            for i, face_landmarks in enumerate(landmarks_detector.get_landmarks(raw_img_path), start=1):
                try:
                    ...
                    aligned_img = image_align(raw_img_path, face_landmarks, output_size=args.output_size, x_scale=args.x_scale, y_scale=args.y_scale, em_scale=args.em_scale, alpha=args.use_alpha)
                    aligned_img.save(aligned_face_path, 'PNG')
